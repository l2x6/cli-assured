...
Find the latest version on https://central.sonatype.com/artifact/org.cli-assured/cli-assured[Maven Central].
...
== `cli-assured-mvn` - a Java DSL for invoking an testing Maven

`cli-assured-mvn` is a sibling of CLI assured for installing and invoking Maven.
